...
type (
	SamplingAppName = string
)

var (
	SamplingAppNameDropSampling          SamplingAppName = "drop-sampling"
	SamplingAppNameACLNewTrafficSampling SamplingAppName = "acl-new-traffic-sampling"
	SamplingAppNameACLEstTrafficSampling SamplingAppName = "acl-est-traffic-sampling"
)
...
type SamplingApp struct {
	...
	ID          int               `ovsdb:"id"`
	Name        SamplingAppName   `ovsdb:"name"`
}
...
func (a *SamplingApp) GetName() SamplingAppName {
	return a.Name
}
